...
const App = () => {
  ...
  const callGemini = async (prompt, retries = 0) => {
    ...
    const systemPrompt =
      "Eres un Senior UI Engineer experto. Analizas el proyecto UHAUS. El stack es Astro, React, Tailwind y GSAP. El Design System usa el color primario #008148 y fuentes Inter/Heebo. Responde de forma técnica, profesional y humana en español.";
  ...
  const handlePredefinedAction = (actionType) => {
    ...
    switch (actionType) {
      case "design":
        prompt =
          "Explica la lógica del Design System de UHAUS basado en el código (#008148) y su relación con la sostenibilidad industrial.";
        break;
      case "astro":
        prompt =
          "Describe por qué la arquitectura de islas de Astro fue la mejor decisión para el SEO y rendimiento de UHAUS.";
        break;
      case "gsap":
        prompt =
          "Analiza el impacto de las animaciones GSAP en la experiencia del usuario para este caso de estudio.";
        break;
      default:
        prompt = userInput;
    }
    ...
    <div className="min-h-screen bg-white text-[#333333] font-sans selection:bg-[#008148]/10">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden px-6 bg-[#ffffff]">
        <div className="absolute top-10 left-10 opacity-40">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-[#008148] rounded-lg flex items-center justify-center text-white italic font-bold">
              U
            </div>
            <p className="text-xs tracking-[0.3em] uppercase font-bold text-[#131313]">
              U HAUS / INGENIERÍA UI
            </p>
          </div>
        </div>
        ...
        <div className="z-10 text-center max-w-5xl">
          ...
          <h1 className="text-6xl md:text-[9rem] font-bold text-[#131313] leading-[0.85] mb-8 tracking-tighter font-secondary">
            UHAUS <br />
            <span className="text-[#008148] font-light italic">
              Ecosistema Térmico
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-[#333333] max-w-2xl mx-auto leading-relaxed font-light">
            Sinterización de ingeniería de materiales y software para una
            experiencia digital de alta eficiencia.
          </p>
        </div>
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(#008148 1px, transparent 1px), linear-gradient(90deg, #008148 1px, transparent 1px)",
      ...
      <section className="py-32 px-6 bg-[#131313] text-white overflow-hidden relative">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-[#008148] font-bold tracking-[0.3em] uppercase text-xs mb-6">
              Proceso de Ingeniería
            </h2>
            <h3 className="text-4xl md:text-5xl font-bold mb-8 font-secondary">
              La ventaja de Astro
            </h3>
            <p className="text-slate-400 text-lg leading-relaxed mb-10">
              El reto no era solo visual; era de rendimiento. Implementé la
              **Arquitectura de Islas de Astro** para garantizar que el
              contenido crítico se sirviera como HTML estático, reduciendo el
              peso del JavaScript y optimizando el SEO para un mercado
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
                ...
                <p className="text-xs text-slate-500">
                  Velocidad de carga instantánea mediante generación estática.
                </p>
              </div>
              <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
                ...
                <p className="text-xs text-slate-500">
                  Interacción dinámica solo donde el usuario la necesita.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-32 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-24">
          <h2 className="text-[#008148] font-bold tracking-[0.3em] uppercase text-xs mb-4">
            Sistema de Diseño
          </h2>
          <h3 className="text-5xl font-bold font-secondary">
          ...
          <div className="space-y-8 md:col-span-2">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="p-8 bg-slate-50 rounded-3xl">
                ...
                <p className="text-4xl font-bold font-secondary mb-4 tracking-tighter">
                  Heebo Heavy
                </p>
                <p className="text-sm leading-relaxed text-slate-500 italic">
                  Solidez visual para titulares que comunican autoridad en
                  aislación.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-20">
            ...
            <p className="text-slate-500 mt-4 max-w-2xl">
              Basado en la estructura del repositorio, el proyecto se divide en
              componentes atómicos que facilitan la escalabilidad y el
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-10 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-shadow">
              ...
              <p className="text-[10px] text-slate-400 mt-2">
                Optimización de etiquetas HTML5
              </p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-shadow">
        ...
        <div className="max-w-6xl mx-auto border border-slate-100 rounded-[3rem] shadow-2xl overflow-hidden group">
          ...
          <div className="p-12 md:p-20 bg-white min-h-[500px] flex flex-col gap-16">
            <nav className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                <div className="w-10 h-10 bg-[#008148] rounded-xl flex items-center justify-center text-white italic font-bold">
                  U
                </div>
                <span className="font-bold text-2xl tracking-tighter uppercase font-secondary">
                  U Haus
                </span>
              </div>
              <div className="hidden md:flex gap-10 text-[11px] font-bold uppercase tracking-[0.2em] text-slate-400">
                <span className="text-[#008148] border-b-2 border-[#008148] pb-1">
                  Ingeniería
                </span>
            ...
            <div className="grid md:grid-cols-2 gap-20 items-center">
              <div className="space-y-8">
                <h4 className="text-7xl font-bold leading-[0.9] tracking-tighter font-secondary uppercase">
                  AISLA <br /> PROTEGE <br />{" "}
                  <span className="text-[#008148]">AHORRA</span>
                </h4>
                <p className="text-slate-500 text-lg leading-relaxed max-w-sm">
                  La celulosa Pro es el material más ecológico y resistente.
                  Implementamos tecnología avanzada para reducir el consumo
                  energético.
                </p>
      ...
      <div
        className={`fixed bottom-6 right-6 z-50 transition-all duration-500 ${isAiOpen ? "w-[400px]" : "w-16"}`}
      >
        {!isAiOpen ? (
          <button
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-slate-50/50 text-sm">
              {aiResponse ? (
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="text-[10px] uppercase font-bold text-[#008148]"
                  >
                    Nueva consulta
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    <button
                      onClick={() => handlePredefinedAction("design")}
                      className="text-left p-4 rounded-xl border border-slate-200 bg-white hover:border-[#008148] transition-all text-slate-600"
                    >
                      ¿Cómo escala el Design System?
                    </button>
                    <button
                      onClick={() => handlePredefinedAction("astro")}
                      className="text-left p-4 rounded-xl border border-slate-200 bg-white hover:border-[#008148] transition-all text-slate-600"
                    >
                      Lógica de las Islas de Astro
                    </button>
                    <button
                      onClick={() => handlePredefinedAction("gsap")}
                      className="text-left p-4 rounded-xl border border-slate-200 bg-white hover:border-[#008148] transition-all text-slate-600"
                    >
              ...
              {isLoading && (
                <div className="flex flex-col items-center justify-center py-10 gap-4">
                  ...
                  <p className="text-[10px] font-bold text-[#008148] animate-pulse">
                    Analizando código...
                  </p>
                </div>
              )}
      ...
      <footer className="py-24 px-6 text-center bg-[#131313] text-white">
        <h2 className="text-[10px] uppercase tracking-[0.4em] font-bold text-[#008148] mb-6">
          Síntesis
        </h2>
        <h3 className="text-4xl font-bold mb-12 font-secondary tracking-tighter uppercase italic">
          Engineering Comfort
        </h3>
        <p className="text-slate-500 text-sm max-w-2xl mx-auto mb-16 leading-relaxed font-light">
          UHAUS es el resultado de una orquestación precisa entre la ingeniería
          de materiales y el desarrollo de software. Al optimizar cada
          milisegundo de carga y cada interacción, no solo entregué una web,
          sino una herramienta que refleja la misma eficiencia que la celulosa
          provee a un hogar.
        </p>
