import { j as I, e as Gn } from "./visual-editing-component.BUBjU8Vu.js";
import { r as un } from "./index.Z3ghWE2m.js";
class G {
  constructor(e, l, t) {
...
function Ln(n, e) {
  const l = {},
    t = {};
  for (const r of n) (Object.assign(l, r.property), Object.assign(t, r.normal));
  return new G(l, t, e);
}
function K(n) {
...
function $(n) {
  ...
  for (const [t, r] of Object.entries(n.properties)) {
    const o = new on(t, n.transform(n.attributes || {}, t), r, n.space);
    (n.mustUseProperty &&
      n.mustUseProperty.includes(t) &&
      (o.mustUseProperty = !0),
      (e[t] = o),
      (l[K(t)] = t),
      (l[K(o.attribute)] = t));
...
const te = Ln([Nn, Yn, _n, jn, In], "html"),
  re = Ln([Nn, Zn, _n, jn, In], "svg");
function fn(n) {
  const e = [],
    l = String(n || "");
  let t = l.indexOf(","),
...
function oe(n, e) {
  ...
  for (; r < l.length; ) {
    pn.lastIndex = r;
    const u = pn.exec(l),
      s = l.slice(r, u ? u.index : l.length);
    (s &&
      (o
        ? o === "#"
          ? (t.id = s)
  ...
  function r(o, a, ...u) {
    ...
    if (o == null) {
      ...
      const c = s.tagName.toLowerCase(),
        p = t ? t.get(c) : void 0;
      if (((s.tagName = p || c), ie(a))) u.unshift(a);
      else for (const [d, h] of Object.entries(a)) ae(n, s.properties, d, h);
    }
    for (const c of u) tn(s.children, c);
    return (
      s.type === "element" &&
        s.tagName === "template" &&
...
function ie(n) {
  if (n === null || typeof n != "object" || Array.isArray(n)) return !0;
    ...
    if (typeof t == "number") {
      ...
      typeof t == "boolean"
        ...
        : typeof t == "string"
          ...
          : Array.isArray(t)
            ? (o = [...t])
            : (o = r.property === "style" ? ue(t) : String(t));
    if (Array.isArray(o)) {
      const a = [];
      for (const u of o) a.push(gn(r, r.property, u));
      o = a;
    }
    (r.property === "className" &&
...
function tn(n, e) {
  if (e != null)
    ...
    else if (Array.isArray(e)) for (const l of e) tn(n, l);
...
function gn(n, e, l) {
  if (typeof l == "string") {
    if (n.number && l && !Number.isNaN(Number(l))) return Number(l);
...
function ue(n) {
  const e = [];
  for (const [l, t] of Object.entries(n)) e.push([l, t].join(": "));
  return e.join("; ");
}
function se(n) {
  const e = new Map();
  for (const l of n) e.set(l.toLowerCase(), l);
  return e;
}
const ce = [
    "altGlyph",
...
function bn(n) {
  ...
  return (l.charCodeAt(l.length - 1) === 59 && n !== "semi") || l === e
    ? !1
    : l;
}
const he = [
...
function me(n, e) {
  const l = {},
    t =
      typeof l.additional == "string"
        ? l.additional.charCodeAt(0)
        : l.additional,
    r = [];
  let o = 0,
    a = -1,
    ...
    c;
  l.position &&
    ("start" in l.position || "indent" in l.position
      ? ((c = l.position.indent), (s = l.position.start))
      : (s = l.position));
  let p = (s ? s.line : 0) || 1,
    d = (s ? s.column : 0) || 1,
    h = m(),
  ...
  for (o--; ++o <= n.length; )
    if (
      (v === 10 && (d = (c ? c[a] : 0) || 1), (v = n.charCodeAt(o)), v === 38)
    ) {
      ...
      let M = "",
        R = "",
        A = "";
      const F = N === "named" ? mn : N === "decimal" ? zn : de;
      for (b--; ++b <= n.length; ) {
        const g = n.charCodeAt(b);
        if (!F(g)) break;
        ((A += String.fromCharCode(g)),
          N === "named" && pe.includes(A) && ((M = A), (R = bn(A))));
      }
      let j = n.charCodeAt(b) === 59;
      if (j) {
        b++;
        const g = N === "named" ? bn(A) : !1;
        g && ((M = A), (R = g));
      }
      let T = 1 + b - S,
        _ = "";
      if (!(!j && l.nonTerminated === !1))
        if (!A) N !== "named" && C(4, T);
        else if (N === "named") {
          if (j && !R) C(5, 1);
          else if (
            (M !== A && ((b = E + M.length), (T = 1 + b - E), (j = !1)), !j)
          ) {
            const g = M ? 1 : 3;
            if (l.attribute) {
              const U = n.charCodeAt(b);
              U === 61 ? (C(g, T), (R = "")) : mn(U) ? (R = "") : C(g, T);
            } else C(g, T);
          }
          _ = R;
        } else {
          j || C(2, T);
          let g = Number.parseInt(A, N === "hexadecimal" ? 16 : 10);
          if (ye(g)) (C(7, T), (_ = "�"));
          else if (g in hn) (C(6, T), (_ = hn[g]));
          else {
            let U = "";
            (be(g) && C(6, T),
              g > 65535 &&
                ((g -= 65536),
                (U += String.fromCharCode((g >>> 10) | 55296)),
                (g = 56320 | (g & 1023))),
              (_ = U + String.fromCharCode(g)));
          }
        }
      if (_) {
        ...
        (g.offset++,
          ...
          (h = g));
      } else ((A = n.slice(S - 1, b)), (u += A), (d += A.length), (o = b - 1));
    } else
      (v === 10 && (p++, a++, (d = 0)),
        Number.isNaN(v) ? w() : ((u += String.fromCharCode(v)), d++));
  return r.join("");
  function m() {
    return { line: p, column: d, offset: o + ((s ? s.offset : 0) || 0) };
  }
  function C(y, S) {
    let E;
    l.warning &&
      ...
      (E.column += S),
      (E.offset += S),
      l.warning.call(l.warningContext || void 0, he[y], E, y));
  }
  function w() {
    u &&
      (r.push(u),
      l.text && l.text.call(l.textContext || void 0, u, { start: h, end: m() }),
      (u = ""));
  }
}
function ye(n) {
...
var ve = 0,
  ...
  O = {
    util: {
      ...
      objId: function (n) {
        return (
          n.__id || Object.defineProperty(n, "__id", { value: ++ve }),
          n.__id
        );
      },
      clone: function n(e, l) {
        ...
        switch (O.util.type(e)) {
          case "Object":
            if (((r = O.util.objId(e)), l[r])) return l[r];
            ((t = {}), (l[r] = t));
            for (var o in e) e.hasOwnProperty(o) && (t[o] = n(e[o], l));
            return t;
          case "Array":
            return (
              (r = O.util.objId(e)),
      ...
      insertBefore: function (n, e, l, t) {
        ...
        for (var a in r)
          if (r.hasOwnProperty(a)) {
            if (a == e) for (var u in l) l.hasOwnProperty(u) && (o[u] = l[u]);
            l.hasOwnProperty(a) || (o[a] = r[a]);
          }
        var s = t[n];
        return (
          (t[n] = o),
          O.languages.DFS(O.languages, function (c, p) {
            p === s && c != n && (this[c] = o);
          }),
          o
        );
        ...
        for (var a in e)
          if (e.hasOwnProperty(a)) {
            ...
            var u = e[a],
              s = O.util.type(u);
            s === "Object" && !r[o(u)]
              ? ((r[o(u)] = !0), n(u, l, null, r))
              : s === "Array" && !r[o(u)] && ((r[o(u)] = !0), n(u, l, a, r));
          }
      },
    },
    plugins: {},
    highlight: function (n, e, l) {
      var t = { code: n, grammar: e, language: l };
      ...
      return (
        ...
        q.stringify(O.util.encode(t.tokens), t.language)
      );
    },
    ...
    hooks: {
      ...
      run: function (n, e) {
        var l = O.hooks.all[n];
        if (!(!l || !l.length)) for (var t = 0, r; (r = l[t++]); ) r(e);
      },
    },
    Token: q,
  };
  ...
  for (var a in l)
    if (!(!l.hasOwnProperty(a) || !l[a])) {
      ...
      for (var s = 0; s < u.length; ++s) {
        ...
        for (
          var C = c.pattern || c, w = t.next, y = r;
          w !== e.tail && !(o && y >= o.reach);
          y += w.value.length, w = w.next
        ) {
          var S = w.value;
          ...
          if (!(S instanceof q)) {
            var E = 1,
              b;
            if (h) {
              if (((b = vn(C, y, n, d)), !b || b.index >= n.length)) break;
              var A = b.index,
              ...
              for (
                var R = w;
                R !== e.tail && (M < N || typeof R.value == "string");
                R = R.next
              )
                (E++, (M += R.value.length));
              (E--, (S = n.slice(y, M)), (b.index -= y));
            } else if (((b = vn(C, 0, S, d)), !b)) continue;
            var A = b.index,
              F = b[0],
              j = S.slice(0, A),
              T = S.slice(A + F.length),
              _ = y + S.length;
            o && _ > o.reach && (o.reach = _);
            var g = w.prev;
            (j && ((g = Y(e, g, j)), (y += j.length)), we(e, g, E));
            var U = new q(a, p ? O.tokenize(F, p) : F, v, F);
            if (((w = Y(e, g, U)), T && Y(e, w, T), E > 1)) {
              var Q = { cause: a + "," + s, reach: _ };
              (Bn(n, e, l, w.prev, y, Q),
...
function Y(n, e, l) {
  var t = e.next,
    r = { value: l, prev: e, next: t };
  return ((e.next = r), (t.prev = r), n.length++, r);
}
function we(n, e, l) {
  for (var t = e.next, r = 0; r < l && t !== n.tail; r++) t = t.next;
...
function Pe(n, e) {
  ...
  if (e && typeof e == "object") l = e;
    ...
    if (Object.hasOwn(k.languages, t)) l = k.languages[t];
    else throw new Error("Unknown language: `" + t + "` is not registered");
  }
  return { type: "root", children: Fn.highlight.call(k, n, l, t) };
}
function Se(n) {
...
function Ae() {
  const n = k.languages,
    e = [];
  let l;
  for (l in n) Object.hasOwn(n, l) && typeof n[l] == "object" && e.push(l);
  return e;
}
function rn(n, e) {
  if (typeof n == "string") return { type: "text", value: n };
  if (Array.isArray(n)) {
    const t = [];
    let r = -1;
    for (; ++r < n.length; )
      n[r] !== null && n[r] !== void 0 && n[r] !== "" && t.push(rn(n[r], e));
    return t;
  }
  const l = {
    attributes: {},
  ...
  return (
    n.alias &&
      l.classes.push(...(typeof n.alias == "string" ? [n.alias] : n.alias)),
    k.hooks.run("wrap", l),
    fe(l.tag + "." + l.classes.join("."), Me(l.attributes), l.content)
  );
}
function Ee(n) {
  return n;
...
function Me(n) {
  let e;
  for (e in n) Object.hasOwn(n, e) && (n[e] = me(n[e]));
  return n;
}
const an = function (n) {
  if (n == null) return Re;
  if (typeof n == "function") return J(n);
  if (typeof n == "object") return Array.isArray(n) ? De(n) : Le(n);
  if (typeof n == "string") return Ne(n);
  throw new Error("Expected function, string, or object as test");
};
function De(n) {
  const e = [];
  let l = -1;
  for (; ++l < n.length; ) e[l] = an(n[l]);
  return J(t);
  function t(...r) {
    let o = -1;
    for (; ++o < e.length; ) if (e[o].apply(this, r)) return !0;
    return !1;
  }
}
function Le(n) {
  ...
  function l(t) {
    const r = t;
    let o;
    for (o in n) if (r[o] !== e[o]) return !1;
    return !0;
  }
}
function Ne(n) {
...
function J(n) {
  ...
  function e(l, t, r) {
    return !!(
      Te(l) && n.call(this, l, typeof t == "number" ? t : void 0, r || void 0)
    );
  }
}
function Re() {
...
function je(n, e, l) {
  const t = an(e),
    r = e && typeof e == "object" && "cascade" in e ? e.cascade : void 0,
    o = r ?? !0;
  return a(n);
  function a(u, s, c) {
    const p = [];
    ...
    if (Ie(u)) {
      let v = -1;
      for (; ++v < u.children.length; ) {
        const m = a(u.children[v], v, u);
        m && p.push(m);
      }
      if (o && u.children.length > 0 && p.length === 0) return;
    }
    const d = {};
    let h;
    for (h in u) _e.call(u, h) && (d[h] = h === "children" ? p : u[h]);
    return d;
  }
}
function Ie(n) {
...
function wn(n, e, l, t) {
  let r;
  typeof e == "function" && typeof l != "function"
    ? ((t = l), (l = e))
    : (r = e);
  const o = an(r),
    a = t ? -1 : 1;
  ...
  function u(s, c, p) {
    ...
    function h() {
      let v = $n,
        ...
        w;
      if (
        (!e || o(s, c, p[p.length - 1] || void 0)) &&
        ((v = Be(l(s, p))), v[0] === xn)
      )
        return v;
      if ("children" in s && s.children) {
        const y = s;
        if (y.children && v[0] !== ze)
          for (
            C = (t ? y.children.length : -1) + a, w = p.concat(y);
            C > -1 && C < y.children.length;
          ) {
            const S = y.children[C];
            if (((m = u(S, C, w)()), m[0] === xn)) return m;
...
var Fe = Object.defineProperty,
  ...
  Pn = (n, e, l) =>
    e in n
      ? Fe(n, e, { enumerable: !0, configurable: !0, writable: !0, value: l })
      : (n[e] = l),
  Vn = (n, e) => {
    for (var l in e || (e = {})) Ve.call(e, l) && Pn(n, l, e[l]);
    if (Cn) for (var l of Cn(e)) qe.call(e, l) && Pn(n, l, e[l]);
    return n;
  },
  qn = (n, e) => He(n, $e(e));
function We(n, e) {
  const l = e.markers
      .map((r) => (typeof r == "number" ? { line: r } : r))
      .sort((r, o) => r.line - o.line),
    t = Wn(n.children).nodes;
  return l.length === 0 || t.length === 0
    ? qn(Vn({}, n), { children: t })
    : Xe(t, l, e);
}
...
`);
        for (let u = 0; u < a.length; u++) {
          const s = u === 0 ? e.lineNumber : ++e.lineNumber,
            c = {
              type: "text",
              value:
                u === a.length - 1
...
`,
      ...
      if (r.type === "element" && r.children) {
        const a = Wn(r.children, e),
          u = a.nodes.find(Z),
          s = a.nodes.findLast(Z);
        return (
          W(r, u ? V(u, o) : o, s ? z(s, o) : o),
          (r.children = a.nodes),
...
function Ke(n, e) {
  ...
  function u(p, d, h) {
    (a.push(d),
      h.forEach((m) => {
        p.has(m) ||
          (p.set(m, Object.assign({}, m, { children: [] })),
          m !== l && a.push(m));
      }));
    let v = h.length;
    for (; v--; ) {
      const m = p.get(h[v]);
      if (!m || !("children" in m)) continue;
      const C = h[v + 1],
        w = p.get(C) || d;
  ...
  wn(l, (p, d) => {
    if (!("children" in p || !Z(p))) {
      ...
      z(p) > n && a.some((h) => d.includes(h)) && u(o, p, d);
    }
  });
  const s = je(l, (p) => a.indexOf(p) === -1),
    c = (p) => {
      const d = p.get(l);
      return d
        ? (wn(d, (h, v) => {
            ...
            v.forEach((m) => {
              W(m, Math.max(V(m), V(h)), Math.max(z(m), z(h)));
            });
          }),
          d.children)
        : [];
    };
  return [...c(t), ...c(r), ...c(o), ...(s ? s.children : [])];
}
function Ge(n, e, l) {
  const t = e.className || "refractor-marker",
    r = { lineStart: e.line, lineEnd: z(n[n.length - 1]), isMarker: !0 };
  return {
    type: "element",
    tagName: "div",
    data: e.component
      ? qn(Vn({}, r), { component: e.component, markerProperties: l })
      : r,
...
function Xe(n, e, l) {
  const t = e.reduce((a, u) => Ke(u.line, a), n),
    r = [];
  let o = 0;
  for (let a = 0; a < e.length; a++) {
    const u = e[a];
    for (let c = t[o]; c && z(c) < u.line; c = t[++o]) r.push(c);
    const s = [];
    for (let c = t[o]; c && z(c) === u.line; c = t[++o])
...
var Ye = Object.defineProperty,
  ...
  On = (n, e, l) =>
    e in n
      ? Ye(n, e, { enumerable: !0, configurable: !0, writable: !0, value: l })
      : (n[e] = l),
  kn = (n, e) => {
    for (var l in e || (e = {})) Qe.call(e, l) && On(n, l, e[l]);
    if (Sn) for (var l of Sn(e)) nl.call(e, l) && On(n, l, e[l]);
    return n;
  },
  el = (n, e) => Ze(n, Je(e));
function Kn(n) {
...
function ll(n, e, l) {
  if (n.type === "doctype") return null;
  if (!("tagName" in n)) return n.value;
  let t = "";
  typeof n.properties < "u" &&
    (t = Array.isArray(n.properties.className)
      ? n.properties.className.join(" ")
      : `${n.properties.className}`);
  const r = `fract-${l}-${e}`,
    o = n.children && n.children.map(Kn(l + 1));
  return tl(n.data)
    ? un.createElement(
        n.data.component,
        el(kn(kn({ key: r }, n.properties), n.data.markerProperties), {
          className: t,
        }),
        o,
      )
...
var rl = Object.defineProperty,
  ...
  En = (n, e, l) =>
    e in n
      ? rl(n, e, { enumerable: !0, configurable: !0, writable: !0, value: l })
      : (n[e] = l),
  Mn = (n, e) => {
    for (var l in e || (e = {})) al.call(e, l) && En(n, l, e[l]);
    if (An) for (var l of An(e)) ul.call(e, l) && En(n, l, e[l]);
    return n;
  },
  Dn = (n, e) => ol(n, il(e));
const sl = "refractor";
function cl(n) {
  const e = n.className || sl,
    l = `language-${n.language}`,
    t = { className: l },
    r = [e, l].filter(Boolean).join(" ");
  if (
    (n.inline && ((t.style = { display: "inline" }), (t.className = e)),
    n.plainText)
  ) {
    const s = I.jsx("code", Dn(Mn({}, t), { children: n.value }));
    return n.inline ? s : I.jsx("pre", { className: r, children: s });
  }
  let o = k.highlight(n.value, n.language);
  n.markers && n.markers.length > 0 && (o = We(o, { markers: n.markers }));
  const a = o.children.length === 0 ? n.value : o.children.map(Kn(0)),
    u = I.jsx("code", Dn(Mn({}, t), { children: a }));
  return n.inline ? u : I.jsx("pre", { className: r, children: u });
}
const fl = (n) => k.registered(n);
function pl(n) {
  const e = Gn.c(13),
    { language: l, value: t } = n,
    r = typeof l == "string" ? l : void 0;
  let o;
  e[0] !== r ? ((o = r ? fl(r) : !1), (e[0] = r), (e[1] = o)) : (o = e[1]);
  const a = o;
  let u;
  e[2] !== r || e[3] !== a || e[4] !== t
    ? ((u = !(r && a) && I.jsx("code", { children: t })),
      (e[2] = r),
      (e[3] = a),
      (e[4] = t),
      (e[5] = u))
  ...
  let s;
  e[6] !== r || e[7] !== a || e[8] !== t
    ? ((s = r && a && I.jsx(cl, { inline: !0, language: r, value: String(t) })),
      (e[6] = r),
      (e[7] = a),
      (e[8] = t),
      (e[9] = s))
  ...
  return (
    e[10] !== u || e[11] !== s
      ? ((c = I.jsxs(I.Fragment, { children: [u, s] })),
        (e[10] = u),
        (e[11] = s),
        (e[12] = c))
      : (c = e[12]),
